      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-32 pb-20 flex flex-col md:flex-row gap-8">
        ...
        <main className="flex-grow">
          ...
          <div className="space-y-8">
            ...
            <p><strong>1.3 Component-Specific Terms:</strong> Our platform consists of three main components: Global Shield, Email Protector, and Security Tester. Privacy policies and specific terms appear for each system component individually. You are only required to accept terms for the components you choose to activate and use.</p>
          </section>
            <section id="service-description">
              <h2 className="text-2xl font-semibold mb-4">2. Service Description and Pricing</h2>
            <p className="mb-4"><strong>2.1 Global Shield:</strong> Global Shield provides web application protection, real-time traffic monitoring, country blacklisting, and port closing features. Global Shield protects against all types of web attacks including DDoS, SQL injection, and other common web vulnerabilities, except business logic vulnerabilities. Pricing: $0.06 per GB of traffic processed, with no limits and no additional fees.</p>
            <p className="mb-4"><strong>2.2 Email Protector:</strong> Email Protector offers AI-based email protection with advanced email flow visualization, phishing and spoofing defense, malware scanning, and spam filtering. The service includes a secure webmail client that supports Outlook and Gmail-based accounts only. Pricing: $10 per month per email account, including up to 10 emails per day. Additional emails are charged at $0.035 each.</p>
            <p className="mb-4"><strong>2.3 Security Tester:</strong> Security Tester provides dynamic and static application security testing, AI-powered code analysis, and vulnerability assessment reporting. Pricing: $25 per month, including up to 50 full vulnerability checks. Additional full vulnerability checks are charged at $0.5 each.</p>
            <p><strong>2.4 Pricing Changes:</strong> We reserve the right to modify our pricing at any time. Price changes will be communicated through our platform and will take effect for new billing cycles after the notification period.</p>
          </section>
            <section id="sla">
            ...
            <p className="mb-4"><strong>4.3 Vulnerability Testing Scope and Responsibility:</strong> When using our Security Tester component: You are solely responsible for ensuring you have authorization to conduct penetration testing on all targeted systems. We are not responsible for any unauthorized penetration testing activities you may conduct. On somebody else’s system You acknowledge that you are responsible for any actions taken through our vulnerability testing tools.</p>
            <p className="mb-4"><strong>4.4 AI-Based Vulnerability Scanner:</strong> Our AI-based vulnerability scanner conducts comprehensive vulnerability tests based on the IP address or domain name provided during dynamic vulnerability testing. Users may store up to 200 vulnerability reports. To conduct additional vulnerability checks beyond this limit, existing vulnerability reports must be deleted first.</p>
