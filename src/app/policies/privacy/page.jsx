      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-32 pb-20 flex flex-col md:flex-row gap-8">
        ...
        <main className="flex-grow">
          ...
          <div className="space-y-8">
            ...
            <p className="mb-4"><strong>1.1 Introduction:</strong> This Privacy Policy describes how Silence AI LLC ("Silence AI," "we," "us," or "our") collects, uses, processes, and protects your personal information when you use our cybersecurity platform and services. This policy applies to all components of our platform: Global Shield, Email Protector, and Security Tester.</p>
            <p className="mb-4"><strong>1.2 Controller Information:</strong> Silence AI LLC serves as the data controller for personal data processed through our services. Our business registration location is Media City Free Zone, Al Messaned, Sharjah, UAE.</p>
            <p><strong>1.3 Component-Specific Processing:</strong> Each service component processes different types of data. You will only be subject to data processing activities for components you choose to activate and use.</p>
          </section>
            ...
            <p>Our services are not intended for individuals under 18 years of age. We do not knowingly collect personal information from children under 18. If you become aware that a child has provided us with personal information, please contact us immediately.</p>
          </section>
            <section id="changes">
